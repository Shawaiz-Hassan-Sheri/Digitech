...
class _ProfileChainState extends State<CheckProgress> {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSingleContainer(
              endText: userModel.progress,
              startText: "Account Status",
            ),
            _buildSingleContainer(
                ...
                myDoc.forEach((checkDocs) {
                  if (checkDocs.data()["UserId"] == userUid) {
                    userModel = UserModel(
                      ...
                      usertransactionImage: checkDocs.data()["UserTransactionImage"],
                      ...
                      children: [
                       ...
                       Divider(
                        ...
                        InteractiveViewer(
                          ...
                          minScale: 0.5,
                          maxScale: 2.5,
                          child:Image.network(userModel.usertransactionImage,),
